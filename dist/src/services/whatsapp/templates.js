...
export function formatMorningPrep(analysis, marketContext, portfolioValue) {
...
export function formatPostSettle(analysis, portfolioContext, marketContext) {
...
// --- Intraday Alert ---
export function formatIntradayAlert(analysis, triggerType, triggerDetails) {
    const priorityEmoji = {
...
export function formatEveningWrap(analysis, todayRecs, portfolioContext) {
    const date = new Date().toLocaleDateString('en-IN', {
        weekday: 'short', day: 'numeric', month: 'short', year: 'numeric',
    });
...
export function formatWeeklyDigest(analysis, weekRecs, portfolioContext, weekPerformance) {
...
// --- User Query Response ---
export function formatQueryResponse(analysis) {
    let msg = '';
    if (analysis.action !== 'NO_ACTION' && analysis.symbols?.length) {
...
// --- Status Message ---
export function formatStatusMessage(holdings, totalValue) {
