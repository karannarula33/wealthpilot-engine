...
import { AIAnalysisInput, AIAnalysisOutput, AIUsageStats } from '../../types';
...
`;
  ...
  private parseResponse(text: string): AIAnalysisOutput {
    try {
  ...
  private computeUsage(usage: any, startTime: number): AIUsageStats {
